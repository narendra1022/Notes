...
//    lateinit var noteTagEdt:EditText
...
//        noteTagEdt = findViewById(R.id.idNoteTag)
        ...
        if (noteType.equals("Edit")) {
            ...
            val noteTag =intent.getStringExtra("noteTag")
            val noteDescription = intent.getStringExtra("noteDescription")
            noteID = intent.getIntExtra("noteId", -1)
            noteTitleEdt.setText(noteTitle)
//            noteTagEdt.setText(noteTag)
...
//            val noteTag=noteTagEdt.text.toString()
